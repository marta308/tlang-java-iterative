...
/**
 * @ast node
 * @declaredat /home/marta/workspace/TLang_iterative/src/spec/TLang.ast:11
 * @production DeclarationHook : {@link FieldOrHookDeclaration};

 */
public class DeclarationHook extends FieldOrHookDeclaration implements Cloneable {
  /**
   * @apilevel internal
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /home/marta/workspace/TLang_iterative/src/spec/PrettyPrint.jrag:49
   */
  ...
  /**
   */
  public DeclarationHook(beaver.Symbol p0) {
    setName(p0);
  }
  /**
   * @apilevel low-level
