...
/**
 * @ast node
 * @declaredat /home/marta/workspace/TLang_iterative/src/spec/CompositionLang.ast:15
 * @production BindCopy : {@link Composer};

 */
public class BindCopy extends Composer implements Cloneable {
  /**
   * @apilevel internal
   */
  public BindCopy clone() throws CloneNotSupportedException {
    BindCopy node = (BindCopy) super.clone();
    return node;
  }
  /**
   * @apilevel internal
   */
  public BindCopy copy() {
    try {
      BindCopy node = (BindCopy) clone();
      node.parent = null;
      if(children != null) {
   ...
   * @apilevel low-level
   */
  public BindCopy fullCopy() {
    BindCopy tree = (BindCopy) copy();
    if (children != null) {
  ...
  /**
   */
  public BindCopy(String p0, String p1) {
    setTargetName(p0);
    setSourceName(p1);
  }
  /**
   */
  public BindCopy(beaver.Symbol p0, beaver.Symbol p1) {
    setTargetName(p0);
    setSourceName(p1);
  }
  /**
